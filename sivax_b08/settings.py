"""
Django settings for sivax_b08 project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-sf(gl*xyi1hu^s9u^qrppn3yh81enjr(_s18$60!u6pi%rshi1')
...
WSGI_APPLICATION = 'sivax_b08.wsgi.application'
